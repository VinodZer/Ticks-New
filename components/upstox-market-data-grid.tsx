...
export function UpstoxMarketDataGrid({
  ...
  const getSortedAndFilteredTrades = (instrumentToken: string) => {
    ...
    <>
      ...
      <Dialog open={!!selectedInstrument} onOpenChange={() => setSelectedInstrument(null)}>
        <DialogContent className="w-[95vw] max-w-6xl h-[95vh] max-h-[95vh] p-0 gap-0">
          ...
          <DialogHeader className="px-4 sm:px-6 py-3 sm:py-4 border-b bg-gradient-to-r from-purple-50 to-indigo-50 flex-shrink-0">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <DialogTitle className="text-lg sm:text-xl font-bold text-gray-900 truncate">
                    {selectedInstrument ? getUpstoxInstrumentName(selectedInstrument) : ""}
                  </DialogTitle>
              ...
              {selectedInstrument && (
                <div className="flex items-center gap-3 sm:gap-4 flex-shrink-0">
                  ...
                  <Badge variant="outline" className="text-xs">
                    {getUpstoxExchange(selectedInstrument)}
                  </Badge>
                </div>
              )}
            </div>
                    ...
                    <TableBody>
                      {selectedInstrument &&
                        getSortedAndFilteredTrades(selectedInstrument.instrument_token).map((trade, index) => {
                          ...
                          return (
                            <TableRow key={trade.id} className="hover:bg-purple-50/50 transition-colors">
                              <TableCell>
                                <div className="flex items-center gap-2">
                                  <div
